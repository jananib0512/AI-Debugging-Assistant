...
const relatedMap: Record<string, RelatedLink[]> = {
  ...
  "call-graph": [
    { path: "function-class-intelligence", label: "Func/Class Intelligence", desc: "View function and class details" },
    ...
    { path: "semantic-intelligence", label: "Semantic Intelligence", desc: "View semantic analysis" },
  ],
  "semantic-intelligence": [
    { path: "call-graph", label: "Call Graph", desc: "View call relationships" },
    { path: "function-class-intelligence", label: "Func/Class Intelligence", desc: "View function details" },
    { path: "file-intelligence", label: "File Intelligence", desc: "View file health scores" },
  ],
  ...
  technology: [
    { path: "framework", label: "Framework Intelligence", desc: "View framework details" },
  ...
  "entry-points": [
    ...
    { path: "framework", label: "Framework Intelligence", desc: "View framework starters" },
  ],
  configuration: [
  ...
  "unified-intelligence": [
    ...
    { path: "code-quality", label: "Code Quality", desc: "View code quality scores" },
    { path: "semantic-intelligence", label: "Semantic Intelligence", desc: "View semantic understanding" },
    { path: "call-graph", label: "Call Graph", desc: "View execution flows" },
    { path: "function-class-intelligence", label: "Func/Class Intel", desc: "View function details" },
    ...
    { path: "risk-intelligence", label: "Risk Intelligence", desc: "View project risk assessment" },
    { path: "security-intelligence", label: "Security Intel", desc: "View security analysis" },
    { path: "performance-intelligence", label: "Performance Intel", desc: "View performance analysis" },
  ],
  "risk-intelligence": [
    { path: "architecture", label: "Architecture", desc: "View architecture health" },
    { path: "dependencies", label: "Dependencies", desc: "View dependency health" },
