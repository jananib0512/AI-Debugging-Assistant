...
from app.repositories.risk_intelligence_engine import RiskIntelligenceEngine
...
class RiskIntelligenceService:
    ...
    def analyze(self, user_id: int, project_id: int) -> RiskIntelligenceResponse:
        ...
        risks = [
            RiskItem(
                ...
                affected_classes=r.get("affected_classes", []),
        ...
        heatmap = [RiskHeatmapItem(**h) for h in result.get("heatmap", [])]
