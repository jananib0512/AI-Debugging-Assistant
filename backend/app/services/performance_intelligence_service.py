...
class PerformanceIntelligenceService:
    ...
    def analyze(self, user_id: int, project_id: int) -> PerformanceIntelligenceResponse:
        ...
        score = PerformanceScore(**result["performance_score"])
        findings = [PerformanceFinding(**f) for f in result.get("findings", [])]
        summary = PerformanceSummary(**result["summary"])
