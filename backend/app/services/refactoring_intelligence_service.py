...
from app.repositories.refactoring_intelligence_engine import RefactoringIntelligenceEngine
...
class RefactoringIntelligenceService:
    def __init__(self, db: Session = Depends(get_db)):
        self._project_repo = ProjectRepository(db)

    def analyze(self, user_id: int, project_id: int) -> RefactoringIntelligenceResponse:
        ...
        engine = RefactoringIntelligenceEngine()
        ...
        score = RefactoringScore(**result["refactoring_score"])
        opportunities = [RefactoringOpportunity(**o) for o in result.get("opportunities", [])]
        summary = RefactoringSummary(**result["summary"])

        return RefactoringIntelligenceResponse(
